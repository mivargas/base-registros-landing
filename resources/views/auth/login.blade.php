...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>Landing </b>Creator</a>
    </div>

    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Inicia sesión para crear tu landing page.</p>
        ...
        <a href="{{ url('/user_register') }}" class="text-center">Registrate</a>
